...
class CAE(nn.Module):
    ...
    Latent representation: 128x16x16 bits per patch => 240KB per image (for 720p)
    """
    ...
    def __init__(self):
        ...
        self.e_conv_1 = nn.Sequential(
            ...
            nn.Conv2d(in_channels=3, out_channels=128, kernel_size=(5, 5), stride=(2, 2)),
            nn.LeakyReLU()
        )
        ...
        self.e_conv_2 = nn.Sequential(
            nn.ZeroPad2d((1, 2, 1, 2)),
            nn.Conv2d(in_channels=128, out_channels=128, kernel_size=(5, 5), stride=(2, 2)),
            nn.LeakyReLU()
        )
        ...
        self.e_conv_3 = nn.Sequential(
            nn.Conv2d(in_channels=128, out_channels=48, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2)),
            nn.Tanh()
        )
